...
var ajaxservice = function ajaxservice(term) {
  ...
  var key = "iko7tt1HNDl6x4zoaiEq";
  return fetch("".concat(url).concat(term, "&key=").concat(key)).then(function (respone) {
    return respone.json();
  });
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkaplikacija"] = self["webpackChunkaplikacija"] || [];
